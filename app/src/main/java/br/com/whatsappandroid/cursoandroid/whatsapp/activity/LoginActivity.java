        ...
        autenticacao.signInWithEmailAndPassword(
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    identificadorUsuarioLogado = Base64Custom.condificarBase64(usuario.getEmail());
                    ...
                    try{
                        ...
                        erroExcecao = "O e-mail do usuário está errado ou desabilitado!";
                    }catch (FirebaseAuthInvalidCredentialsException e){
                        erroExcecao = "A senha do usuário está errada!";
                    } catch (Exception e) {
